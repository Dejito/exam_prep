...
class _TabScreensState extends State<TabScreens> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: selectedIndex == 0 ? const Color(0xFF79F3A1) : Colors.black,
      appBar: AppBar(
        backgroundColor: selectedIndex == 0 ? const Color(0xFF79F3A1) : Colors.black,
        title: titleText(
            text: "Hello,\nAlexandra!",
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: selectedIndex == 0 ? const Color(0xFF79F3A1) : Colors.black, // Border color
        ...
        child: Row(
          ...
          children: [
            ...
            FloatingActionButton.extended(
              ...
              backgroundColor: selectedIndex Colors.black,
